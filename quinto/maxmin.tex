...
\end{center}
 Per $x=-5$ e per $x=-1$ la  derivata e la funzione non esistono e la funzione non ha un flesso. Rimanendo di segno costante non ha punti di minimo e di massimo\index{Massimo}\index{Minimo}\index{Flesso}
\end{exercise}
\tcbstoprecording
\newpage
\section{Soluzione esercizi}
