...
\end{center}
Per $x=-2$ la derivata è positiva nulla negativa, quindi la funzione ha un massimo. Per $x=2$ la derivata è negativa nulla positiva, quindi la funzione ha un minimo. Per $x=0$ la derivata non esiste e la funzione non a un flesso.\index{Massimo}\index{Minimo} 
\end{exercise}
\tcbstoprecording
\newpage
\section{Soluzione esercizi}
